...
# Der offizielle Installer legt netbird in /usr/local/bin/ ab
...
# 2. Setup‑Key abfragen (Abbruch führt zum Beenden)
...
sudo netbird up --management-url https://netbird.vmhaus.de --setup-key "$SETUP_KEY"
